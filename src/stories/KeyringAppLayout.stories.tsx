...
import {
  Layout as KeyringAppLayout,
  Props as KeyringAppLayoutProps,
} from "../layouts/KeyringAppLayout";
...
const Template: Story<KeyringAppLayoutProps> = (args) => (
  <KeyringAppLayout {...args} />
);
